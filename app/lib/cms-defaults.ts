...
export const defaultCmsContent: CmsContent = {
  ...
  services: [
    ...
    },
    {
      ...
      image: "/images/winter-fishing.webp",
      alt: "Kış sezonu için denizde ilerleyen küçük balıkçı teknesi",
  ...
  galleryCollections: {
    summer: {
      title: "Yaz galerisi",
      summary: "Gezi, yüzme, SUP ve yemekli tekne günü için seçili kareler.",
      items: [
        {
          kind: "photo",
          title: "Mordoğan koy molası",
        ...
        },
        {
          ...
          alt: "Yaz turunda denizde yüzme molası",
        },
        {
          kind: "photo",
          title: "Teknede sofra",
    ...
    winter: {
      title: "Kış galerisi",
      summary: "Olta balıkçılığı, sakin deniz ve kaptan kontrollü rota için seçili kareler.",
      items: [
        {
          kind: "photo",
          title: "Kış rota çıkışı",
          src: "/images/coast-boat.webp",
          alt: "Kış sezonunda sakin koy hattında ilerleyen tekne",
          featured: true,
        },
        {
          kind: "video",
          title: "Olta hazırlığı",
          src: "/images/winter-fishing.webp",
          alt: "Kış sezonunda olta balıkçılığı için denizde ilerleyen tekne",
        },
        {
          kind: "photo",
          title: "Açık deniz planı",
          src: "/images/clear-water.webp",
          alt: "Berrak deniz yüzeyi ve sakin rota görünümü",
        },
        {
          kind: "photo",
          title: "Kıyı manzarası",
          src: "/images/okan-clear-coast.webp",
          alt: "Mordoğan ve Karaburun kıyısında berrak deniz manzarası",
        },
        {
          kind: "photo",
          title: "Sakin deniz",
          src: "/images/hero-boat.webp",
          alt: "Sakin denizde tekne turu görünümü",
        },
      ],
    },
  },
  socialGalleryItems: [
    {
      ...
      image: "/images/okan-boat-cove.webp",
      alt: "Instagram Reel için Mordoğan tekne turu görüntüsü",
    },
    {
      platform: "Facebook",
      title: "Tekneden kısa video",
      href: "https://www.facebook.com/share/v/1CtBctSpmQ/?mibextid=wwXIfr",
      image: "/images/summer-swim.webp",
      alt: "Facebook videosu için yaz turu yüzme molası görüntüsü",
    },
  ],
  ...
  route: {
    ...
    coves: ["Ayıbalığı Koyu", "Korsan Yatağı (Alifendere)", "Manal Koyu"],
  },
  tourSpecs: [
    {
  ...
  mealMenu: [
    { title: "Ana yemek", text: "Kasap köfte, tavuk pirzola veya ızgara çupra" },
    { title: "Yan lezzetler", text: "Mevsim salatası, makarna ve 4 çeşit soğuk meze" },
    { title: "Yemek içeceği", text: "Yemek esnasında kola, Fanta veya ayran ikramı" },
    { title: "Sıcak ikram", text: "Gün boyu çay, yemek sonrası Türk kahvesi servisi" },
  ],
  amenityItems: [
    {
